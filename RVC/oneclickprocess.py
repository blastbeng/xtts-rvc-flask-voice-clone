...
if if_gpu_ok and len(gpu_infos) > 0:
    ...
    print("GPU Mem is: "+str(mem)+". Using default_batch_size: " +str(default_batch_size))
else:
...
print("Using default_batch_size: " + str(default_batch_size))
...
def vc_single(
    ...
    try:
        ...
        output_file_path = os.path.join(os.environ.get("TMP_DIR") + "/" +model_name + ".wav")
...
print("Found n_cpus: " + str(config.n_cpu))
...
if mode == "train":
    ...
    pretrained_G14 = "../data/f0G48k.pth"
    pretrained_D15 = "../data/f0D48k.pth"
    ...
    spk_item = 0
    vc_transform0 = 0
    input_audio0 = os.environ.get("TMP_DIR") + "/" +model_name + ".wav"
    f0method0 = "crepe"
    filter_radius0 = 3
    file_index1 = ""
